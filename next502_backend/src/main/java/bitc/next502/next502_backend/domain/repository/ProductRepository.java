...
public interface ProductRepository extends JpaRepository<WarehouseEntity, Long> {


    @Query("SELECT p FROM WarehouseEntity as p " +
    ...
    List<WarehouseEntity> searchProducts(
